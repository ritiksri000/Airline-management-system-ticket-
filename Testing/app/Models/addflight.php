<?php
		...
		{
			public $temp, $temp2;
			public function addFlightDetails($affected_rows)
			{
			...
			public function chk_submit($tempstr)
			{
				$this->temp2 = $tempstr;
	
			}

			public function get_chk_submit()
			{
				return $this->temp2;
			}
		}
